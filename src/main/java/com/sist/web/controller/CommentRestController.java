...
public class CommentRestController {
	...
	public ResponseEntity<Map> comment_list(@RequestParam("cno") int cno, @RequestParam("type") int type) {
		...
		return new ResponseEntity<>(commonsData(cno, type), HttpStatus.OK);
	}
	...
	public ResponseEntity<Map> comment_delete(@RequestParam("cno") int cno, @RequestParam("type") int type,
	...
	public ResponseEntity<Map> comment_delete(@RequestParam("cno") int cno, @RequestParam("type") int type,
			@RequestParam("no") int no, @RequestParam("msg") String msg) {
		Map map=new HashMap();
		try {
